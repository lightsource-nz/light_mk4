...
//! instantiation. The application is `light_app_dictaphone`, with no hardware in it; this
...
pub extern "C" fn light_app_main(info: &ShellInfo) -> ! {
        ...
        // into core 1's
        //   STAGE is STREAM_WORDS * 2: one full mono refill -- a stage smaller than one
        // refill reads short and declares the playback finished on its first buffer
        static STAGE: ConstStaticCell<[u8; light_rp2::i2s::STREAM_WORDS * 2]> = ConstStaticCell::new([0; light_rp2::i2s::STREAM_WORDS * 2]);
